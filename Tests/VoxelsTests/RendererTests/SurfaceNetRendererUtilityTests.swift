...
final class SurfaceNetRendererUtilityTests: XCTestCase {
    func testEstimateSurfaceEdgeIntersection0() throws {
        ...
        let result = SurfaceNetRenderer<Float>.estimateSurfaceEdgeIntersection(corner1: 0, corner2: 1, value1: 0.5, value2: -0.5)
    ...
    func testEstimateSurfaceEdgeIntersection1() throws {
        ...
        let result = SurfaceNetRenderer<Float>.estimateSurfaceEdgeIntersection(corner1: 0, corner2: 1, value1: 1, value2: 0)
    ...
    func testCentroidOfIntersections() throws {
        ...
        let result = SurfaceNetRenderer<Float>.centroidOfEdgeIntersections(dists: dists)
        ...
        let cornerResult = SurfaceNetRenderer<Float>.centroidOfEdgeIntersections(dists: cornerDists)

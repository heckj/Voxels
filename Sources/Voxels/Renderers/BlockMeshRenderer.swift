    ...
    public static func renderFramedVoxel(idx: VoxelIndex, scale: VoxelScale<Float>, inset: Float) -> MeshBuffer {
        ...
        let faces: [CubeFace: [SIMD3<Float>]] = [
            ...
            .x: [ // "right", order viewed when looking "in"
                [0, 0, 0], [0, sOne, 0], [0, sOne - inset, inset], [0, 0, sOne - inset],
                [0, 0, 0], [0, sOne - inset, inset], [0, 0, sOne], [0, inset, sOne - inset],
                [0, inset, sOne - inset], [0, sOne - inset, sOne - inset], [0, 0, sOne], [0, sOne, sOne],
                [0, sOne - inset, inset], [0, sOne, 0], [0, sOne - inset, sOne - inset], [0, sOne, sOne],
            ],
            .xneg: [ // "left", order viewed when looking "in"
                [sOne, sOne, 0], [sOne, 0, 0], [sOne, 0, sOne - inset], [sOne, sOne - inset, inset],
                [sOne, sOne - inset, inset], [sOne, 0, 0], [sOne, inset, sOne - inset], [sOne, 0, sOne],
                [sOne, sOne - inset, sOne - inset], [sOne, inset, sOne - inset], [sOne, sOne, sOne], [sOne, 0, sOne],
                [sOne, sOne, 0], [sOne, sOne - inset, inset], [sOne, sOne, sOne], [sOne, sOne - inset, sOne - inset],
            ],
